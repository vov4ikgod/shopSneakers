...
window.addEventListener('click', function(event) {
    ...
    if (event.target.hasAttribute('data-cart')) {
        ...
        // Собираем данные с этого мовара и записываем их в единый объект productInfo
        const productInfo = {
            id: card.dataset.id,    // id
            imgSrc: card.querySelector('.product-img').getAttribute('src'), // фото
        ...
        // ПОВЕРКА есть ли товар в корзине
